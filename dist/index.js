...
var AvatarComponent = /** @class */ (function (_super) {
    ...
    AvatarComponent.prototype.render = function () {
        ...
        return ((0, jsx_runtime_1.jsx)(OptionContextProvider_1.OptionContextProvider, { optionContext: this.optionContext, children: (0, jsx_runtime_1.jsx)(avatar_1.default, { avatarStyle: avatarStyle, style: style, className: className }) }));
    };
